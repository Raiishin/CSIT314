...
function Staffweb() {
  ...
  if(isQuickBuy){
    quickBuyContent = 
      <>
        ...
        <div style={styles.quickBuySubContainter}>
          ...
          <select onChange={(val)=>changeMovie(val) } disabled={(cinema)?null:"disabled"} style={styles.selectStyle}>
        ...
        <div style={styles.quickBuySubContainter}>
          ...
          <select onChange={(val)=>changeTime(val)} disabled={(movie)?null:"disabled"} style={styles.selectStyle}>
        ...
        <div style={styles.quickBuyButtonContainer}>
          ...
          <button style={styles.quickBuyButtonBlue}>
            {"Go"}  
          </button>
          <div style={{flex:1}}/>
        </div>
    ...
    checkPurchaseContent = 
      ...
      <div>
        <p>
          Enter Customer Email/Mobile No
        </p>
        <select>
          <option></option>
          <option></option>
  ...
  return (
    <div style={styles.container}>
      <StaffNavbar currentIndex="staff-home" />
      <div style={styles.topContainer}>
        <div style={styles.buyCheckContainer}>
          <div style={styles.buyCheckButtonContainer}>
            <button onClick={()=>toggleQuickBuy(true)} style={(isQuickBuy)?styles.buyCheckButtonActive:styles.buyCheckButton}>
              {"Quick Buy"}
            </button>
            <button onClick={()=>toggleQuickBuy(false)} style={(!isQuickBuy)?styles.buyCheckButtonActive:styles.buyCheckButton}>
              {"Check Purchase"}
            </button>
          </div>
