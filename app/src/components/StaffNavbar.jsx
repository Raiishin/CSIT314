    ...
    <div style={styles.container}>
      ...
      <div style={styles.navContainer}>
        <div style={styles.navSubContainer}>
            <a href="/" style={(props.currentIndex == "staff-home")?styles.active:styles.navLink}>
            {"Home"}
            </a>
            <a href="/services" style={(props.currentIndex == "serviecs")?styles.active:styles.navLink}>
            {"Hall Movies"}
            </a>
            <a href="/contact-us" style={(props.currentIndex == "contact")?styles.active:styles.navLink}>
            {"Promotions"}
            </a>
        </div>
